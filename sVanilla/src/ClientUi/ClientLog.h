...
#define MLogT(ModuleName, ...)      CLINET_LOG_TRACE(concatenate_strings(ModuleName, fmt::format(__VA_ARGS__)))
#define MLogD(ModuleName, ...)      CLINET_LOG_DEBUG(concatenate_strings(ModuleName, fmt::format(__VA_ARGS__)))
#define MLogI(ModuleName, ...)      CLINET_LOG_INFO(concatenate_strings(ModuleName, fmt::format(__VA_ARGS__)))
#define MLogW(ModuleName, ...)      CLINET_LOG_WARN(concatenate_strings(ModuleName, fmt::format(__VA_ARGS__)))
#define MLogE(ModuleName, ...)      CLINET_LOG_ERROR(concatenate_strings(ModuleName, fmt::format(__VA_ARGS__)))
#define MLogC(ModuleName, ...)      CLINET_LOG_OFF(concatenate_strings(ModuleName, fmt::format(__VA_ARGS__)))
...
#define CLog_Unique_TimerK(KEY)     Log_Unique_Timer(KEY, CLINET_LOG_INFO)
#define CLog_Unique_TimerK_END(KEY) Log_Unique_Timer_END(KEY)
