...
int GenerateMiniDump(PEXCEPTION_POINTERS pExceptionPointers)
{
    ...
    ::wsprintf(LPSTR(szFileName), LPCSTR(L"%s%s-%04d%02d%02d-%02d%02d%02d.dmp"),
               dirPath.toStdWString().c_str(), appName.c_str(),
               stLocalTime.wYear, stLocalTime.wMonth, stLocalTime.wDay,
               stLocalTime.wHour, stLocalTime.wMinute, stLocalTime.wSecond);
    HANDLE hDumpFile = ::CreateFile(
        LPCSTR(szFileName), GENERIC_READ | GENERIC_WRITE,
    ...
    pfnMiniDumpWriteDump(::GetCurrentProcess(), ::GetCurrentProcessId(),
                         ...
                         (pExceptionPointers ? &expParam : nullptr), nullptr,
                         nullptr);
...
#elif __APPLE__
bool dumpCallback(const char* dump_path, const char* id, void* context,
                  bool succeeded)
{
    Q_UNUSED(dump_path)
    Q_UNUSED(id)
...
void DumpColletor::registerDumpHandle()
{
    ...
    google_breakpad::ExceptionHandler eh(pathAsStr, nullptr, dumpCallback,
